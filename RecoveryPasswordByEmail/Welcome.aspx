...
<head runat="server">
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="css/style.default.css" id="themestylesheet">
...
<body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top" style="background-color:blueviolet;">
        <div class="container"><a href="#Home" class="logo"><img src="img/techwanicom.jfif" alt="logo" width="70">Tech Wani</a>
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="#references" class="nav-link">My work</a></li>
              <li class="nav-item"><a href="#customers" class="nav-link">Clients</a></li>
    ...
    <section id="intro" style="background: url(img/home.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-left">
        ...
        <div class="container text-center"><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />
          <h1 data-animate="fadeInDown" class="text-shadow mb-5">Welcome To Tech Wani</h1>
        
        
          <p data-animate="slideInUp" class="h3 text-shadow text-400">We provide the best projects for the final year students, connect to us you will get to the top</p>
         </div>
      </div>
    </section>
    ...
    *** REFERENCES IMAGE ***
    ...
    <!-- Map-->
    <div id="map"></div>
    <footer class="main-footer" style="background-color:ActiveCaption; height:200px;">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center text-lg-right">
            <p class="social">
                ...
                <a href="#" data-wow-delay="0.6s" class="email wow fadeInUp"><i class="fa fa-envelope  "></i></a></p>
          </div>
          <!-- /.6-->

            <form id="form1" runat="server">
        <div>
            <h6>Welcome <asp:Label ID="lblusername" runat="server" Text="Label"></asp:Label></h6>
        ...
        <div class="col-md-12 text-right text-lg-right mt-4 mt-lg-0">
            <p>© 2019 Wani Mudasir. All rights reserved.</p>
        </div>
        </right>
